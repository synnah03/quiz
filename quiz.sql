...
\restrict 4nNAoR5s1GolQx5xoQ7w8Fmm3RpTXHrT0T6P6YMmH2DkkqYVSoRtdmBhhPSlIzH
...
ALTER SEQUENCE public.attempt_answers_id_seq OWNER TO postgres;
...
--
-- Name: quiz_attempts quiz_attempts_quiz_id_user_id_unique; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: attempt_answers attempt_answers_option_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: attempt_answers attempt_answers_question_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: attempt_answers attempt_answers_quiz_attempt_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: questions questions_quiz_id_foreign; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: quizzes quizzes_created_by_foreign; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
\unrestrict 4nNAoR5s1GolQx5xoQ7w8Fmm3RpTXHrT0T6P6YMmH2DkkqYVSoRtdmBhhPSlIzH
